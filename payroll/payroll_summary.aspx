...
<body class='AdminPage'>
    <form id="frmMain" name="frmMain" method="post" runat="server">
        ...
        <ul id="ulMain" class="nav nav-tabs" >
            <li class="active"><a href="#oTab1" data-toggle="tab">Normal</a></li>
            <li><a data-toggle="tab" href="#oTab2">PayInAdvance</a></li>
        </ul>
        <div class="tab-content">
            <div id='oTab1'  class="tab-pane fade in active">
            ...
            <div id='oTab2' class="tab-pane fade">
