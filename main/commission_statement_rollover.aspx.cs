    ...
    public partial class commission_statement_rollover : Root {
        ...
        void createRecords() {
            DB.runNonQuery(String.Format(@"
				...
				SELECT 66, UPP.USERID, UPP.DISTRIBUTIONOFFUNDS, 0, DATEADD(month, 1, PP.ENDDATE), 'Carried forward balance', 1, 0, 1, UPP.DISTRIBUTIONOFFUNDS, '2-3035', '2-3035', O.OFFICEMYOBCODE + '-' + U.INITIALSCODE, O.OFFICEMYOBCODE + '-' + U.INITIALSCODE, 1
