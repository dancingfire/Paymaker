...
namespace Paymaker {
    ...
    public partial class monthly_sales : Root {
        ...
        protected void bindData() {
            string szFilter = String.Format(" S.SETTLEMENTDATE BETWEEN '{0} 00:00:00' AND '{1} 23:59:59'", Utility.formatDate(dtStart), Utility.formatDate(dtEnd));
            ...
            string szSQL = string.Format(@"
                ...
                USS.GRAPHCOMMISSION AS CALCULATEDAMOUNT, S.SETTLEMENTDATE, S.LISTEDDATE, 
        ...
        protected void formatDataSet(DataSet ds) {
            ...
            dsClone.Tables[0].Columns.Remove("LISTEDDATE");
            ...
            dsClone.Tables[0].Columns.Add(new DataColumn("LISTEDDATE", System.Type.GetType("System.String")));
            ...
            foreach (DataRow oR in ds.Tables[0].Rows) {
                if (currSaleID == -1 || currSaleID != Convert.ToInt32(oR["ID"])) {
                    ...
                    oCloneRow["LISTEDDATE"] = Utility.formatDate(oR["LISTEDDATE"].ToString());
                ...
                switch (oR["COMMISSIONNAME"].ToString()) {
                    ...
                    case "Mentoring":
                        oCloneRow["Mentor"] = Utility.Append(oCloneRow["Mentor"].ToString(), oR["INITIALSCODE"].ToString(), Environment.NewLine);
                        break;
                }
            }
            if (oCloneRow != null) {
