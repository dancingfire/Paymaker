<%@ Page Language="c#" Inherits="Paymaker.monthly_sales_agent_expenses" CodeFile="monthly_sales_agent_expenses.aspx.cs" %>
...
<body class='Report'>
    <form id="frmMain" method="post" runat="server">
        ...
        <div id="dViewer">
            <rsweb:ReportViewer ID="rViewer" runat="server" Width="100%" Height="100%" AsyncRendering="true" SizeToReportContent="true"></rsweb:ReportViewer>
        </div>
    </form>
</body>
</html>