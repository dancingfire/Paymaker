...
namespace Paymaker {
    ...
    public partial class mentoring_commission : Root {
        ...
        private Report getReport() {
            ...
            Report oR = new MebtoringCommission(rViewer, oFilter);
            return oR;
        }
    }
}

public class MebtoringCommission : Report {
    private static string RFileName = "Mentoring commission";
    ...
    public MebtoringCommission(ReportViewer Viewer, ReportFilters oFilter) {
        oViewer = Viewer;
    ...
    public override DataSet getData() {
        ...
        string szSQL = string.Format(@"
                ...
                JOIN SALESPLIT SS_M ON S.ID = SS_M.SALEID AND SS_M.COMMISSIONTYPEID = 89                --Mentor
