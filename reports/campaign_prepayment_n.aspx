<%@ Page Language="c#" Inherits="Paymaker.campaign_prepayment_n" CodeFile="campaign_prepayment_n.aspx.cs" %>
...
<body class='Report'>
    <form id="frmMain" method="post" runat="server">
        ...
        <div id="dViewer">
            <rsweb:ReportViewer ID="rViewer" runat="server" Width="100%" Height="100%" AsyncRendering="true" SizeToReportContent="true" SizeToReportContent="true"></rsweb:ReportViewer>
        </div>
    </form>
</body>
</html>