<%@ Page Language="c#" Inherits="Paymaker.monthly_sales" CodeFile="national_sales_award.aspx.cs" %>
            ...
            <div style="float: left">
                <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SETTLEMENTDATE" HeaderText="Settled Date" HeaderStyle-Width="9%" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="LISTEDDATE" HeaderText="Listed Date" HeaderStyle-Width="9%" ItemStyle-HorizontalAlign="Center" />
