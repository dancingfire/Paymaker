<%@ Page Language="c#" Inherits="Paymaker.agent_eom_balance_and_promo_expenses" CodeFile="agent_eom_balance_and_promo_expenses.aspx.cs" %>
        ...
        <div id="oDetails" style="float: left; clear: left; width: 90%">
            <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="false" Width="99%" OnSorting="gvTable_Sorting">
                <Columns>
                    ...
                    <asp:BoundField DataField="EXPENSES" HeaderText="Promo Expenses" ItemStyle-CssClass='AlignRight' DataFormatString="{0:$0.00}" />
                </Columns>
                <EmptyDataTemplate>
