...
public partial class product_detail : Root {
    ...
    protected void loadData() {
        ...
        string szSQL = string.Format(@"
            SELECT P.ID,  P.DESCRIPTION AS NAME, ISNULL(L_CREDIT.NAME, 'Not set') AS CREDITGLCODE, 
                CASE EXCLUDEFROMINVOICE WHEN 0 THEN 'No' ELSE 'Yes' END AS EXCLUDEFROMINVOICE,
                CASE EXCLUDEFROMMYOBEXPORT WHEN 0 THEN 'No' ELSE 'Yes' END AS EXCLUDEFROMMYOB
