<%@ Page Language="c#" Inherits="user_delegation" EnableViewState="True" AutoEventWireup="true" CodeFile="user_delegation.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function updateDelegation(intID, TypeID, UserID, StartDate, EndDate, ReceiveEmail) {
            $("#hdDBID").val(intID);
            if (intID == -1) {
                $("#lstType").val("0");
                $("#lstUser").val("-1");
            ...
            <div class="row">
                <div class="col-xs-10">
                    ...
                    <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:BoundField DataField="Name" HeaderText="User" HeaderStyle-Width="50%" />
                ...
                <div class='modal-dialog' style='width: 450px; height: 300px'>
                    <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            ...
                            <bw:bwDropDownList runat="server" ID="lstUser" Label="Person" required  />
