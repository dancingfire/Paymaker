...
public class Sale {
    ...
    private void updateAgentExpenseTXRecords() {
        ...
        DB.runNonQuery(String.Format(@"
            ...
            SELECT A.AMOUNT * E.AMOUNT/100, A.AMOUNT * E.AMOUNT/100, 0, E.EXPENSETYPEID, A.USERID, A.ID, 1, ISNULL(S.SETTLEMENTDATE, S.ENTITLEMENTDATE), L.CREDITGLCODE, L.DEBITGLCODE, 'FL-' + U.INITIALSCODE, 'FL-' + U.INITIALSCODE, S.ADDRESS
