...
public class Top_Advertising : Report {
    ...
    public override DataSet getData() {
        ...
        string szQuery = @"
                SELECT U.TOPPERFORMERREPORTSETTINGS AS USERID, U1.INITIALSCODE, U1.ROLEID,
                    ISNULL(SUM(S.ADVERTISINGSPEND), 0) AS AMOUNT
                ...
                GROUP BY U.TOPPERFORMERREPORTSETTINGS,  U1.INITIALSCODE, U1.ROLEID
                ORDER BY ROLEID DESC, AMOUNT DESC;
...
public class Top_Advertising_Average : Report {
    ...
    public override DataSet getData() {
        ...
        string szQuery = @"
                ...
                {0} {1}
                GROUP BY U.TOPPERFORMERREPORTSETTINGS,  U1.INITIALSCODE, U1.ROLEID
                ORDER BY ROLEID ASC, AMOUNT DESC;
    ...
    protected bool setupReport() {
        ...
        try {
            ...
            foreach (DataTable dt in ds.Tables) {
                ...
                // For debuging
                Utility.dataTableToCSVFile(dt, string.Format(@"C:\Temp\output{0}.csv", i));
